...
public class CommonUtil {
  ...
  public static boolean elementNotExistInMainList(List<Object> mainList, List<Object> subList) {
    UtilMsg = "";
    boolean stat = false;
    int subSize = subList.size();
    if (subSize > mainList.size()) {
      stat = false;
    ...
    copyList(mainList, tempMainList);
    for (int i = 0; i < subList.size(); i++) {
      Object o = subList.get(i);
      if (tempMainList.contains(o)) {
        tempMainList.remove(o);
  ...
  public static boolean isBoolean(String strValue) {
    ...
    boolean flag = false;
    try {
      if ((strValue != null) && ((strValue.trim().equalsIgnoreCase("true"))
          || (strValue.trim().equalsIgnoreCase("false"))))
        flag = true;
    } catch (Exception e) {
      flag = false;
    }
  ...
  public static String getCurrentDateTime(String format) {
    ...
    try {
      ...
      LOGGER.error("Exception while getting the date in the specified format" + format
          + " . StackTrace: <br/>" + FwUtil.getStackTrace(ex));
      return null;
    }
  ...
  public static String getDifferenceInDates(Date startDate, Date endDate) {
    ...
    if (startDate.after(endDate)) {
      LOGGER.info("The start date " + startDate + " cannot be after the end date " + endDate
          + ". Please verify.");
      return null;
    }
  ...
  public static boolean isNumericValue(String strValue) {
    ...
    try {
      ...
      return true;
    } catch (NumberFormatException feException) {
    }
    return false;
  }
  ...
  public static boolean compareStringListInSequence(List<Object> list1, List<Object> list2,
      boolean bTrim, boolean bCase) {
    UtilMsg = "";
    ...
    for (int i = 0; i < arrList1.size(); i++) {
      int j = i;
      if ((j >= arrList2.size()) || (StringUtil.stringEqual(arrList1.get(i).toString(),
          arrList2.get(i).toString(), bTrim, bCase)))
        continue;
  ...
  public static String getSecureData(String encString) throws Exception {
    if (encString == null) {
