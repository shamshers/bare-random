...
import com.infinityfw.libraries.Messages;
...
import com.infinityfw.utillib.TakeScreenShot;
...
public class Controller {
  ...
  public void executeKeywordsInTestCase(String testName, String TestDESC, String TestLink_TCID,
  ...
  public static int getParameterTypesAndValues(String objObjInfo, String[] parameterValues) {
    ...
    try {
      ...
      logger.error(err, e);
      WebObject.REPORT.log(LogStatus.ERROR,
  ...
  public static int invokeKeywordThruReflection(String strClass, String strFunc) {
    int res = 1;
    strClass = "com.infinityfw.wrappers." + strClass;
    try {
      if ((strClass != null) && (strClass != "")) {
        ...
        WebObject.REPORT.log(LogStatus.ERROR, "Object class name is null");
        WebObject.REPORT.log(LogStatus.ERROR, "Action: " + strKeywordName + "    "
            + "Status: Failed    " + "Message: Object class name is null");
      }
    } catch (LinkageError e) {
      logger.error("Linkage Exception thrown in invokeKeywordThruReflection for strKeywordName= |"
          + strKeywordName + "|", e);
      WebObject.REPORT.log(LogStatus.ERROR, e.toString());
      String errMsg = "Action: " + strKeywordName + "    " + "Status: Failed    "
          + "Message: An exception occured. Message:" + e.getMessage();
      WebObject.REPORT.log(LogStatus.ERROR, errMsg);
      ...
      if ((t.toString().contains("SeleniumException"))
        ...
        WebObject.REPORT.log(LogStatus.ERROR, msg + " Hence a System exit is performed.");
        System.exit(3);
      }
      String errMsg = "Action: " + strKeywordName + "    " + "Status: Failed    "
          + "Message: An exception occured. Message:" + t.getMessage();
      WebObject.REPORT.log(LogStatus.ERROR,
          "Action: " + strKeywordName + "    " + "Status: Failed    "
              + "Message: An exception occured. Target :" + t.toString() + "   ,  Message:"
              + t.getMessage());
      WebObject.REPORT.log(LogStatus.ERROR, errMsg);
    } catch (Exception e) {
